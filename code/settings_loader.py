...
class SettingsLoader:
    ...
    def save_current_settings(self):
        self.settings = {
            ...
            "draw_lines":self.app.processing_only_lines_checkbox.get(),
    ...
    def load_settings(self):
        self.app.processing_only_lines_checkbox.select() if self.settings['draw_lines'] else self.app.processing_only_lines_checkbox.deselect()
