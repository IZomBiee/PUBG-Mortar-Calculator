...
class App(ct.CTk, AppLogic):
    def __init__(self):
        ...
        self.grid_detection_gap_threshold_slider = CustomSlider(
            ...
            number_of_steps=50, command=self.reload_map_image,
        ...
        self.mark_color_combobox = CustomCombobox(
            ...
            command=self.reload_map_image, return_value=False,
        ...
        self.elevation_draw_points_checkbox = CustomCheckbox(
            ...
            command=self.reload_elevation_image,
        ...
        self.elevation_image = CustomImage(self.right_frame,
            (int(300/1.2), int(480//1.2)), save_aspect_ratio=True
            ).grid(row=0, column=0)
